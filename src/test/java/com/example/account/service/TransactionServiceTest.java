...
import static com.example.account.type.ErrorCode.TRANSACTION_ALREADY_USE_CANCEL;
...
class TransactionServiceTest {
    ...
    void successCancelBalance() {
        ...
        // 기존에 사용한 거래가 취소 됐는지 확인
        assertEquals(USE_CANCEL, transaction.getTransactionType());
    }
    ...
    @Test
    @DisplayName("이미 취소된 거래 - 잔액 사용 취소 실패")
    void cancelTransaction_TransactionAlreadyCancel() {
        //given
        AccountUser user = AccountUser.builder()
                .name("Pobi").build();
        user.setId(12L);
        ...
        //then
        assertEquals(TRANSACTION_ALREADY_USE_CANCEL, exception.getErrorCode());
    }
